...
**SpreadSheet ID**: 1pkiRHypIem0m07j7laZOSSipUQC7MRmHg6O4Cbeeq10
...
**Relaciones Pipeline**: [[N_Caixa_CHF-Pipeline#B2]]  (Opcional)
**Fuentes**:
**Gid**: ![[N_Caixa_CHF-BD_Facturas#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CHF-BD_HistorialFacturas#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CHF-ContextoHoja#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CHF-Form_AsigCostes#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CHF-PProveedores#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CHF-FacturasFaltantes#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CHF-Compr.Fras.Manual#Gid]]
...
**Relaciones Pipeline**: [[N_Caixa_CHF-Pipeline#D0]]
**Fuentes**:
**Gid**: NULL
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CHF-ResumenPlataformas#Gid]]
