...
**Relaciones Pipeline**: [[H0_ControlHumano]], [[N_Caixa_CAD-Pipeline#A1]], [[N_Caixa_CAD-Pipeline#A2]], [[N_Caixa_CAD-Pipeline#C0]] (Opcional)
**Fuentes**: [[N_Caixa_CAD-Pipeline#A1]], y opcionalmente **ArchivadoDeMovimientos**
**Gid**: ![[N_Caixa_CAD-BD_Movimientos#Gid]]

### **BD_AsigCostes**
**Nombre**: 'AsigCostes'
**Objetivo**: Clasificar los gastos para el Cashflow y para [[N_Caixa_CAD-Pipeline#C0]] (Opcional)
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-BD_AsigCostes#Gid]]

### **BD_Facturas** (Opcional)
**Nombre**: 'BD_Facturas'
**Objetivo**: (DataLake?) Bases de datos que almacenan las facturas existentes.
**Relaciones Pipeline**: [[N_Caixa_CAD-Pipeline#B2]]  (Opcional)
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-BD_Facturas#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-BD_HistorialFacturas#Gid]]

### **PreCashflow**
**Nombre**: 'PreCashflow2'
**Objetivo**: (DataMart?) Hoja que agrupa la información relevante para el Cashflow.
**Relaciones Pipeline**: [[N_Caixa_CAD-Pipeline#E1]]
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-PreCashflow2#Gid]]

### **Odoo**
**Nombre**: 'Odoo'
**Objetivo**: (DataMart?) Hoja con los movimientos pendientes de añadir a Odoo.
**Relaciones Pipeline**: [[N_Caixa_CAD-Pipeline#D1]]
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-Odoo#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-ContextoHoja#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-Form_AsigCostes#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-PProveedores#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-FacturasFaltantes#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-Compr.Fras.Manual#Gid]]
...
**Relaciones Pipeline**: [[N_Caixa_CAD-Pipeline#D0]]
**Fuentes**:
**Gid**: NULL
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_CAD-ResumenPlataformas#Gid]]
