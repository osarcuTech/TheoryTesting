...
- Detectamos el banco que corresponde. Todos los archivos contienen en su nombre o en su interior los últimos 4 digitos de la targeta. Se usa esto y/o el contenido (si el nombre del arxivo es incorrecto) para detectar el match del "Importado" con el [[N_Caixa_CAD-AquitecturaBanco#NombreSpreadSheet|Historico]]
- Subimos el archivo a la carpeta correspondiente [[N_Caixa_CAD-AquitecturaArchivos#A1_Input]].

### A1: 
**TLDR**: Update de los historicos de Extractos bancarios
**Objetivo**: Hacer un Upsert de los movimientos bancarios.
**Processo**: 
    - Ejecutamos el [[N_Caixa_CAD-Wf_A1_ImportarMovimientos|workflow]]/script encargado de hacer un processo ETL de los datos añadios a la carpeta a [[N_Caixa_CAD-AquitecturaArchivos#A1_Input]]. 
    - El [[N_Caixa_CAD-Wf_A1_ImportarMovimientos|workflow]]/script los manda a la carpeta [[N_Caixa_CAD-AquitecturaArchivos#A1_Output]] en caso de no estar preparado lo hacemos manualmente para minimizar fuentes con datos duplicados.
    - Los datos se añaden en [[N_Caixa_CAD-BD_Banco]].
...
**Processo**: 
    - Formulas: [[N_Caixa_CAD-BD_Movimientos]], [[N_Caixa_CAD-BD_AsigCostes]]:
...
**Processo**: 
    ...
    - Decisión de carpeta:
        - [[N_Caixa_CAD-AquitecturaArchivos#B1_Input|B1]]: Si hay varias empresas.
        - [[N_Caixa_CAD-AquitecturaArchivos#B1_Output|B2]]: Para la empresa correspondiente (Si estamos seguros de que no hay mezclas). 
...
**Processo**: 
    ...
    - Carpeta Intput: [[N_Caixa_CAD-AquitecturaArchivos#B1_Input|B1]]
    - Carpeta Output Exito: [[N_Caixa_CAD-AquitecturaArchivos#B1_Output|B1]]
    - Carpeta Output Fallo 1: No detecta la empresa [[N_Caixa_CAD-AquitecturaArchivos#B1_Fail_1|B1]]
    - Carpeta Output Fallo 2: No detecta el proveedor [[N_Caixa_CAD-AquitecturaArchivos#B1_Fail_2|B1]]
...
**Processo**: 
    ...
    - Carpeta Intput: [[N_Caixa_CAD-AquitecturaArchivos#B1_Output|B1]]
    - Carpeta Output Exito: [[N_Caixa_CAD-AquitecturaArchivos#B2_Output|B1]]
    - Carpeta Output Fallo 1: No detecta la empresa [[N_Caixa_CAD-AquitecturaArchivos#B1_Fail_1|B1]]
    - Carpeta Output Fallo 2: [[N_Caixa_CAD-AquitecturaArchivos#B1_Fail_1|B1]]
...
**Processo**: 
    - Alternativas:
        - Formulas en Google Sheets: [[N_Caixa_CAD-BD_Movimientos#H]] 
...
**Processo**: 
    - Alternativas:
        - n8n: [[wf_C1_ReenvioFras_context]]. 
            ...
            - El workflow registra automaticamente la id de la factura en [[N_Caixa_CAD-BD_MovimientosT]]
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets [[N_Caixa_CAD-Odoo]].
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets. Lista:
    - Control Plataformas: [[N_Caixa_CAD-ControlPlataformas]].
    - Proveedor1: 
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets [[N_Caixa_CAD-PreCashFlow]].
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets. [[N_Caixa_CAD-AquitecturaArchivos#E1_Input|CarpetaCashFlows]].
