...
**SpreadSheet ID**: 1VZCd6dUUpvCo4IVEqxmrc0oSBeAnim-7JwpTb3QlYYs
...
**Relaciones Pipeline**: [[N_Caixa_PLN-Pipeline#B2]]  (Opcional)
**Fuentes**:
**Gid**: ![[N_Caixa_PLN-BD_Facturas#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_PLN-BD_HistorialFacturas#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_PLN-ContextoHoja#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_PLN-Form_AsigCostes#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_PLN-PProveedores#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_PLN-FacturasFaltantes#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_PLN-Compr.Fras.Manual#Gid]]
...
**Relaciones Pipeline**: [[N_Caixa_PLN-Pipeline#D0]]
**Fuentes**:
**Gid**: NULL
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[N_Caixa_PLN-ResumenPlataformas#Gid]]
