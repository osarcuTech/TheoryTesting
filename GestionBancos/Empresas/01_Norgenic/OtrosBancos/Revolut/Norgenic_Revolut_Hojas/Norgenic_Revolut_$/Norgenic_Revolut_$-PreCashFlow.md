...
- **Formula/s**: =QUERY('BD_Movimientos_$'!A:M;"select H,I,J,sum(E),sum(L) where E is not null group by H,I,J label H 'Periodo', I 'CF in/out', J 'Concepto', sum(E) 'Importe$', sum(L) 'Importe €'";0)
- **Referencias**: 
