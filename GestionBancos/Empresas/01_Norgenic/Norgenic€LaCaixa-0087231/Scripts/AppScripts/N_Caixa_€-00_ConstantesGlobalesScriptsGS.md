## Estructura
Contiene las variables globales de "N_Caixa_€" como resumen de su "arquitectura" de columnas y la logica de manipulación de las mismas para todos los scripts del SpreadSheet.
