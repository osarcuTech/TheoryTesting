...
- **Nombre**: 'Fecha'
- **Contenido**: 
- **Formula/s**: [[N_Caixa_£-BD_Movimientos_Formulas#F1]]
- **Referencias**:  
- **Fuente**: [[N_Caixa_£-BD_Banco]].
...
- **Nombre**: 'Descriptor'.
- **Contenido**: 
- **Formula/s**: [[N_Caixa_£-BD_Movimientos_Formulas#F2]]
- **Referencias**: 
- **Fuente**: 
...
- **Formula/s**: [[N_Caixa_£-BD_Movimientos_Formulas#F6]] !!! COPIAR Y PEGAR VALORES ¡¡¡ para evitar recalculos.
- **Referencias**:  
- **Fuente**: 
...
- **Formula/s**: [[N_Caixa_£-BD_Movimientos_Formulas#F7]] Se hace con la diferencia de los saldos para elminar la diferencia en los tipos de cambio entre los dos dias.
- **Referencias**: 
- **Fuente**: 
