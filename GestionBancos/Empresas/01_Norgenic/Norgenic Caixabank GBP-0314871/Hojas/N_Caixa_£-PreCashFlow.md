...
- **Formula/s**: =QUERY(BD_Movimientos!A:M;"select I,J,K,sum(E),sum(M) where E is not null group by I,J,K label I 'Periodo', J 'CF in/out', K 'Concepto', sum(E) 'ImporteGBP', sum(M) 'Importe €'";0)
- **Referencias**: 
