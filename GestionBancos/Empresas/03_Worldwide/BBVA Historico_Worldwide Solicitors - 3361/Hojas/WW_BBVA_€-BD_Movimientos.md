...
- **Nombre**: 'UID'
- **Contenido**: 
- **Formula/s**: [[WW_BBVA_€-BD_Movimientos_Formulas#F1]]
- **Referencias**:  
...
- **Formula/s**: NULL
- **Referencias**:  
- **Fuente**: [[WW_BBVA_€-BD_Movimientos#A]].
...
- **Nombre**: 'Descriptor'
- **Contenido**: 
- **Formula/s**: [[WW_BBVA_€-BD_Movimientos_Formulas#F2]]
- **Referencias**: 
- **Fuente**:  .
...
- **Nombre**: 'Periodo'
- **Contenido**: 
- **Formula/s**: [[WW_BBVA_€-BD_Movimientos_Formulas#F3]]
- **Referencias**: 
- **Fuente**:  .
...
- **Nombre**: 'CF in/out'
- **Contenido**: 
- **Formula/s**: [[WW_BBVA_€-BD_Movimientos_Formulas#F4]]
- **Referencias**: 
- **Fuente**:  .
...
- **Nombre**: 'CF category'
- **Contenido**: 
- **Formula/s**: [[WW_BBVA_€-BD_Movimientos_Formulas#F5]]
- **Referencias**: 
- **Fuente**:  .
