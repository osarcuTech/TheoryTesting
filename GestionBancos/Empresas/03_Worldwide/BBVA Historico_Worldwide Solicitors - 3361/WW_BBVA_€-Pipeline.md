...
- Detectamos el banco que corresponde. Todos los archivos contienen en su nombre o en su interior los últimos 4 digitos de la targeta. Se usa esto y/o el contenido (si el nombre del arxivo es incorrecto) para detectar el match del "Importado" con el [[WW_BBVA_€-AquitecturaBanco#NombreSpreadSheet|Historico]]
- Subimos el archivo a la carpeta correspondiente [[WW_BBVA_€-AquitecturaArchivos#A1_Input]].
...
**Processo**: 
    - Formulas: [[WW_BBVA_€-BD_Movimientos]], [[WW_BBVA_€-BD_AsigCostes]]:
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets [[WW_BBVA_€-Odoo]].
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets [[WW_BBVA_€-PreCashFlow]].
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets. [[WW_BBVA_€-AquitecturaArchivos#E1_Input|CarpetaCashFlows]].
