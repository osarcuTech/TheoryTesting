...
Listar las formulas de [[WW_Caixa_€-BD_Movimientos]]
...
## 📋 F2
=ArrayFormula((C2:C&"\s"&D2:D)) Separador distindo del habitual
...
## 📋 F6
=ArrayFormula(SI(REGEXMATCH(C2:C;"(?i)google");"Google";""))
