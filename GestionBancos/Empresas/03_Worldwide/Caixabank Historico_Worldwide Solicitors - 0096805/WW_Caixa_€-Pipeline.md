...
**Processo**: 
    - Ejecutamos el workflow/[[WW_Caixa_€-A1_ImportarMovimientos|script]] encargado de hacer un processo ETL de los datos añadios a la carpeta a [[WW_Caixa_€-AquitecturaArchivos#A1_Input]]. 
    - El workflow/[[WW_Caixa_€-A1_ImportarMovimientos|script]] los manda a la carpeta [[WW_Caixa_€-AquitecturaArchivos#A1_Output]] en caso de no estar preparado lo hacemos manualmente para minimizar fuentes con datos duplicados.
...
**Processo**: 
    ...
    - Carpeta Intput: [[WW_Caixa_€-AquitecturaArchivos#B1_Input|Facturacion_Generica]]
    - Carpeta Output Exito: [[WW_Caixa_€-AquitecturaArchivos#B1_Output|Cuadrar]]
    - Carpeta Output Fallo 1: No detecta la empresa [[WW_Caixa_€-AquitecturaArchivos#B1_Fail_1|Unwnown]]
    - Carpeta Output Fallo 2: No detecta el proveedor [[WW_Caixa_€-AquitecturaArchivos#B1_Fail_2|InformaciónFaltante]]
...
**Processo**: 
    ...
    - Carpeta Intput: [[WW_Caixa_€-AquitecturaArchivos#B1_Output|Cuadrar]]
    - Carpeta Output Exito: [[WW_Caixa_€-AquitecturaArchivos#C1_Input|CarpetaFacturas]]
