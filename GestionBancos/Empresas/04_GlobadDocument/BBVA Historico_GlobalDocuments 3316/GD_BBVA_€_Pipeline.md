...
**Processo**: Formulas en Google Sheets (ej: [[GD_BBVA_€-BD_Movimientos#H]] en su momento usamo el actualmente deprecado [[wf_C0_PuntearFacturas_context]] pero actualmente no hay ningún worklow n8n funcional) o manualmente [[H0_ControlHumano]]. 
