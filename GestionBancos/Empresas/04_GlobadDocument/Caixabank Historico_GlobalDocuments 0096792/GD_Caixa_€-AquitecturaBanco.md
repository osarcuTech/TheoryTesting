...
**NombreSpreadSheet**: Caixabank Historico_GlobalDocuments 0096792
**SpreadSheet ID**: 12SdzO29iKwuZjaLLeCdbe0Kqb_b9tLRhmsZ9RRsmgF8
...
**Relaciones Pipeline**: [[GD_Caixa_€-Pipeline#B2]]  (Opcional)
**Fuentes**:
**Gid**: ![[GD_Caixa_€-BD_Facturas#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_Caixa_€-BD_HistorialFacturas#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_Caixa_€-ContextoHoja#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_Caixa_€-Form_AsigCostes#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_Caixa_€-PProveedores#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_Caixa_€-FacturasFaltantes#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_Caixa_€-Compr.Fras.Manual#Gid]]
...
**Relaciones Pipeline**: [[GD_Caixa_€-Pipeline#D0]]
**Fuentes**:
**Gid**: NULL
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_Caixa_€-ResumenPlataformas#Gid]]
