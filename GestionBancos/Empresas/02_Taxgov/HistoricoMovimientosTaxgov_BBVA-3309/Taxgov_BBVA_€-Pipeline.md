...
**Processo**: 
    - Ejecutamos el [[T_BBVA_€-Wf_A1_ImportarMovimientos|workflow]]/script encargado de hacer un processo ETL de los datos añadios a la carpeta a [[T_BBVA_€-AquitecturaArchivos#A1_Input]]. 
    - El [[T_BBVA_€-Wf_A1_ImportarMovimientos|workflow]]/script los manda a la carpeta [[T_BBVA_€-AquitecturaArchivos#A1_Output]] en caso de no estar preparado lo hacemos manualmente para minimizar fuentes con datos duplicados.
...
**Processo**: 
    ...
    - Carpeta Intput: [[T_BBVA_€-AquitecturaArchivos#B1_Input|B1]]
    - Carpeta Output Exito: [[T_BBVA_€-AquitecturaArchivos#B1_Output|B1]]
    - Carpeta Output Fallo 1: No detecta la empresa [[T_BBVA_€-AquitecturaArchivos#B1_Fail_1|B1]]
    - Carpeta Output Fallo 2: No detecta el proveedor [[T_BBVA_€-AquitecturaArchivos#B1_Fail_2|B1]]
...
**Processo**: 
    ...
    - Carpeta Intput: [[T_BBVA_€-AquitecturaArchivos#B1_Output|B1]]
    - Carpeta Output Exito: [[T_BBVA_€-AquitecturaArchivos#B2_Output|B1]]
    - Carpeta Output Fallo 1: No detecta la empresa [[T_BBVA_€-AquitecturaArchivos#B1_Fail_1|B1]]
    - Carpeta Output Fallo 2: [[T_BBVA_€-AquitecturaArchivos#B1_Fail_1|B1]]
...
**Processo**: 
    - Alternativas:
        - Formulas en Google Sheets: [[T_BBVA_€-BD_Movimientos#H]] 
...
**Processo**: 
    - Alternativas:
        - n8n: [[wf_C1_ReenvioFras_context]]. 
            ...
            - El workflow registra automaticamente la id de la factura en [[T_BBVA_€-BD_MovimientosT]]
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets. Lista:
    - Control Plataformas: [[T_BBVA_€-ControlPlataformas]].
    - Proveedor1: 
