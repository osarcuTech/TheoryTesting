...
**Relaciones Pipeline**: [[GD_BBVA_€-Pipeline#B2]]  (Opcional)
**Fuentes**:
**Gid**: ![[GD_BBVA_€-BD_Facturas#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_BBVA_€-BD_HistorialFacturas#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_BBVA_€-Form_AsigCostes#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_BBVA_€-FacturasFaltantes#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_BBVA_€-Compr.Fras.Manual#Gid]]
...
**Relaciones Pipeline**: 
**Fuentes**:
**Gid**: ![[GD_BBVA_€-ResumenPlataformas#Gid]]
