...
**Processo**: 
    - Ejecutamos el [[GD_BBVA_€-A1_ImportarMovimientos|workflow]]/script encargado de hacer un processo ETL de los datos añadios a la carpeta a [[GD_BBVA_€-AquitecturaArchivos#A1_Input]]. 
    - El [[GD_BBVA_€-A1_ImportarMovimientos|workflow]]/script los manda a la carpeta [[GD_BBVA_€-AquitecturaArchivos#A1_Output]] en caso de no estar preparado lo hacemos manualmente para minimizar fuentes con datos duplicados.
...
**Processo**: 
    ...
    - Carpeta Intput: [[GD_BBVA_€-AquitecturaArchivos#B1_Input|Facturacion_Generica]]
    - Carpeta Output Exito: [[GD_BBVA_€-AquitecturaArchivos#B1_Output|Cuadrar]]
    - Carpeta Output Fallo 1: No detecta la empresa [[GD_BBVA_€-AquitecturaArchivos#B1_Fail_1|Unwnown]]
    - Carpeta Output Fallo 2: No detecta el proveedor [[GD_BBVA_€-AquitecturaArchivos#B1_Fail_2|InformaciónFaltante]]
...
**Processo**: 
    ...
    - Carpeta Intput: [[GD_BBVA_€-AquitecturaArchivos#B1_Output|Cuadrar]]
    - Carpeta Output Exito: [[GD_BBVA_€-AquitecturaArchivos#C1_Input|CarpetaFacturas]]
