...
**Processo**: 
    - Ejecutamos el workflow/[[GD_Caixa_€-A1_ImportarMovimientos|script]] encargado de hacer un processo ETL de los datos añadios a la carpeta a [[GD_Caixa_€-AquitecturaArchivos#A1_Input]]. 
    - El workflow/[[GD_Caixa_€-A1_ImportarMovimientos|script]] los manda a la carpeta [[GD_Caixa_€-AquitecturaArchivos#A1_Output]] en caso de no estar preparado lo hacemos manualmente para minimizar fuentes con datos duplicados.
