...
- Detectamos el banco que corresponde. Todos los archivos contienen en su nombre o en su interior los últimos 4 digitos de la targeta. Se usa esto y/o el contenido (si el nombre del arxivo es incorrecto) para detectar el match del "Importado" con el [[GD_Caixa_€-AquitecturaBanco#NombreSpreadSheet|Historico]]
- Subimos el archivo a la carpeta correspondiente [[GD_Caixa_€-AquitecturaArchivos#A1_Input]].

### A1: 
**TLDR**: Update de los historicos de Extractos bancarios
**Objetivo**: Hacer un Upsert de los movimientos bancarios.
**Processo**: 
    - Ejecutamos el [[GD_Caixa_€-Wf_A1_ImportarMovimientos|workflow]]/script encargado de hacer un processo ETL de los datos añadios a la carpeta a [[GD_Caixa_€-AquitecturaArchivos#A1_Input]]. 
    - El [[GD_Caixa_€-Wf_A1_ImportarMovimientos|workflow]]/script los manda a la carpeta [[GD_Caixa_€-AquitecturaArchivos#A1_Output]] en caso de no estar preparado lo hacemos manualmente para minimizar fuentes con datos duplicados.
    - Los datos se añaden en [[GD_Caixa_€-BD_Banco]].
...
**Processo**: 
    - Formulas: [[GD_Caixa_€-BD_Movimientos]], [[GD_Caixa_€-BD_AsigCostes]]:
...
**Processo**: 
    ...
    - Decisión de carpeta:
        - [[GD_Caixa_€-AquitecturaArchivos#B1_Input|B1]]: Si hay varias empresas.
        - [[GD_Caixa_€-AquitecturaArchivos#B1_Output|B2]]: Para la empresa correspondiente (Si estamos seguros de que no hay mezclas). 
...
**Processo**: 
    ...
    - Carpeta Intput: [[GD_Caixa_€-AquitecturaArchivos#B1_Input|B1]]
    - Carpeta Output Exito: [[GD_Caixa_€-AquitecturaArchivos#B1_Output|B1]]
    - Carpeta Output Fallo 1: No detecta la empresa [[GD_Caixa_€-AquitecturaArchivos#B1_Fail_1|B1]]
    - Carpeta Output Fallo 2: No detecta el proveedor [[GD_Caixa_€-AquitecturaArchivos#B1_Fail_2|B1]]
...
**Processo**: 
    ...
    - Carpeta Intput: [[GD_Caixa_€-AquitecturaArchivos#B1_Output|B1]]
    - Carpeta Output Exito: [[GD_Caixa_€-AquitecturaArchivos#B2_Output|B1]]
    - Carpeta Output Fallo 1: No detecta la empresa [[GD_Caixa_€-AquitecturaArchivos#B1_Fail_1|B1]]
    - Carpeta Output Fallo 2: [[GD_Caixa_€-AquitecturaArchivos#B1_Fail_1|B1]]
...
**Processo**: 
    - Alternativas:
        - Formulas en Google Sheets: [[GD_Caixa_€-BD_Movimientos#H]] 
...
**Processo**: 
    - Alternativas:
        - n8n: [[wf_C1_ReenvioFras_context]]. 
            ...
            - El workflow registra automaticamente la id de la factura en [[GD_Caixa_€-BD_MovimientosT]]
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets [[GD_Caixa_€-Odoo]].
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets. Lista:
    - Control Plataformas: [[GD_Caixa_€-ControlPlataformas]].
    - Proveedor1: 
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets [[GD_Caixa_€-PreCashFlow]].
...
**Processo**: manual [[H0_ControlHumano]] assistido por formulas en Google Sheets. [[GD_Caixa_€-AquitecturaArchivos#E1_Input|CarpetaCashFlows]].
